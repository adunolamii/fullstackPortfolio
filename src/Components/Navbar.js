  ...
  return (
    ...
    <div className='text-red-600 h-12 rounded-3xl  bg-slate-700 w-80 m-auto '>
        <div className='rounded-lg flex justify-around py-3  '>
           ...
           <Link to="portfolio" className='portfolio'><button><MdAssignmentTurnedIn className='text-white hover:scale-110 duration-200  text-xl  hover:to-orange-500' /></button></Link>
