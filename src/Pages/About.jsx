  ...
  return (
    <PageTransition>
      <div className=" h-screen w-full  bg-gradient-to-b from-black to-gray-800 p-4 text-white">
        ...
        <Roll>
          <div className=" mt-4 flex">
            <div className="relative bg-blue-300 w-64 h-64 rounded-3xl m-auto my-4 rounded-t-10 rounded-b-none rounded-t-full">
              <img
                className="w-44 h-44 m-auto object-cover mt-16 "
                src={pic}
                alt=""
              />
            </div>
        ...
        <Zoom>
          <div>
            <h1 className=" text-white items-center justify-center px-12">
              I am an expert in{" "}
              <span className="font-bold text-pink-500 text-2xl">
                MERN STACK
              </span>{" "}
              Development. I design, create and deploy a complete application
              from scratch to finish with the use of various tools.{" "}
            </h1>
          </div>
        </Zoom>
        ...
        <Flip>
          <div className="flex justify-evenly  group-hover:rotate-90 duration-300">
            <button
              className=" p-2 font-bold text-xl text-white bg-gradient-to-b from-pink-600 to-purple-900 px-6 py-2 my-8 hover:scale-110 duration-300"
              onClick={() => {
                navigate("/contact");
              }}
            >
